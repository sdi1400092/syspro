...
Στην υλοποιηση μου δεν καταφερα να κανω χρηση signals για να κανω push τον worker στην ουρα με τους διαθεσιμους worker αφοτου τελειωσε. Υπαρχει στις σειρες 371-379 ενα κομματι σχολιασμένου κωδικα με το οποιο ο manager περιμενει τον worker να τελειωσει με τη χρηση της waitpid() που αμα βγει απο σχολιο το προγραμμα θα τρεξει απλα επειδη ο manager περιμενει τον πρωτο worker που γινεται pop να τελειωσει και μετα τον κανει push θα ειναι παντα αυτος ο worker που θα παιρνει τη δουλεια και επειδη για να κανει καινουργιο read απο το pipe(listener) o manager θα πρεπει να περασει το σημειο του waitpid() που σημαινει οτι ηδη θα εχει γινει push ο υπαρχον worker στην ουρα και ποτέ δεν θα χρειαστει να δημιουργθει καινουργιος worker. Τον κωδικα τον αφησα ως εχει πιστευοντας οτι δειχνει καλυτερα την λειτουγια του και τη δυνατοτητα του να διαχειριστει πολλα processes και πολλα named pipes. Το κακο ειναι οτι αφου τελειωσει ενας worker τη δουλεια του μπαινει σε stopped κατασταση και δεν ξαναδεχεται SIGCONT ποτέ.
Ένας τροπος που βρηκα και φαινοταν πιο σωστος ηταν ο εξης. Μετα τη γραμμη 367 αντι για ελεγχο αν βρισκεται στον πατερα να κανει ενα fork() και η διεργασια πατερας να συνεχιζει την επαναληψη και η διεργασια παιδι να εκτελει τις εντολες μεσα σε αυτο το if δηλαδη τις γραμμες 371-381 και μετα το waitpid μεσω ενος pipe που θα εχει δημιουργηθει εξω απο το while(1) της γραμμης 270 θα στελνει στον πατερα(manager) το id της διεργασιας που τερματισε καθος και το ονομα του named pipe της διεργασιας αυτης και στη συνεχεια θα στελνει στον εαυτο της SIGKILL για να τερματιζει(χωρις την εντολη queue_push() ). Με τη σειρα του ο manager πριν κανει ελεγχο να διαβασει απο το pipe που εχει με τον listener θα κανει εναν ελεγχο να διαβασει απο το pipe που εχει με το παιδι που δημιουργηθηκε για να κανει waitpid() τον worker. Αν υπαρχει κατι να διαβασει θα διαβαζει το processid και το ονομα του named pipe του worker που τελειωσε και θα τον κανει push στην ουρα με τους διαθεσιμους worker. Δυστυχως αυτη την ιδεα δεν προλαβα να την υλοποιησω σε λειτουργικο επιπεδο και οι αλλαγες στον κωδικα ηταν αρκετα μεγαλες για να τον αφησω σχολιασμενο οποτε δεν υπαρχουν ουτε σχολια με τον κωδικα που περιεγραψα.
